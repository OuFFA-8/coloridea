...
export const routes: Routes = [
...

  {
    path: 'select-project',
    loadComponent: () =>
      import('./features/client/project-select/project-select').then((m) => m.ProjectSelect),
...

  {
    path: 'cameras',
    loadComponent: () =>
      import('./features/client/client-cameras/client-cameras').then((m) => m.ClientCameras),
    canActivate: [authGuard],
  },
  {
  ...
  // ===== CLIENT =====
  {
    ...
    children: [
      ...
      },
      {
        path: 'settings',
        loadComponent: () =>
          import('./features/client/client-settings/client-settings').then((m) => m.ClientSettings),
      },
      {
        path: 'managers',
        loadComponent: () => import('./features/client/managers/managers').then((m) => m.Managers),
      },
      {
        path: 'verify-email/:token',
        loadComponent: () =>
          import('./features/client/verify-email/verify-email').then((m) => m.VerifyEmail),
      },
      {
        path: 'files',
        loadComponent: () => import('./features/client/files/files').then((m) => m.Files),
      },
      {
        path: 'projects/:id',
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./features/client/project-details/project-details').then(
                (m) => m.ProjectDetails,
              ),
          },
          {
            path: 'deliverables',
            loadComponent: () =>
              import('./features/client/deliverables/deliverables').then((m) => m.Deliverables),
          },
          {
            path: 'financials',
            loadComponent: () =>
  ...
  // ===== ADMIN =====
  {
    ...
    children: [
      ...
      },
      {
        path: 'clients/:id',
        loadComponent: () =>
          import('./features/admin/client-details/client-details').then((m) => m.ClientDetails),
      },
      {
        path: 'projects',
      ...
      },
      {
        path: 'projects/:id',
        loadComponent: () =>
          import('./features/admin/admin-project-details/admin-project-details').then(
            (m) => m.AdminProjectDetails,
          ),
      },
      {
        path: 'settings',
      ...
      },
      {
        path: 'verify-email/:token',
        loadComponent: () =>
          import('./features/admin/admin-verify-email/admin-verify-email').then(
            (m) => m.AdminVerifyEmail,
          ),
      },
    ],
  },
